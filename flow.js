    ...
    switch (phase) {
      ...
      case PHASE.FOUNDATION:
        return {
          ...
          sectionLead:
            'أنت مسجّل الدخول. المتبقي: قراءة المقال التعريفي حتى آخره، ثم يُفتح المسار الأول.',
          kicker: 'مطلوب قبل المسارات',
          title: 'المقال التعريفي ثم المسارات',
          hint: 'مقال واحد عن HCI وUX/UI. القراءة تُحتسب فقط إذا وصلت للنهاية، وبعدها تُفتح المسارات.',
          cta: 'متابعة البداية ←',
