    ...
    switch (phase) {
      case PHASE.GUEST:
        return {
          ...
          sectionLead:
            'بعد إنشاء الحساب تُوجَّه تلقائياً: اختيار المسار ← البداية ← المقال التعريفي ← المسارات بالترتيب.',
          kicker: 'للزائر',
          title: 'ابدأ بإنشاء حساب',
          hint: 'الحساب يحفظ تقدّمك. بعد التسجيل نوجّهك خطوة بخطوة — دون أن تتساءل أين تبدأ.',
      ...
      case PHASE.FOUNDATION:
        return {
          ...
          sectionLead:
            'أنت مسجّل الدخول. المتبقي: قراءة صفحة البداية والمقال التعريفي، ثم يُفتح المسار الأول.',
          kicker: 'مطلوب قبل المسارات',
          title: 'صفحة البداية والمقال التعريفي',
          hint: 'شرح موجز للمنصة والتخصص، ثم مقال واحد عن HCI وUX/UI. بعدها تُفتح المسارات بالترتيب.',
          cta: 'متابعة البداية ←',
